...
public final class Messages {
    ...
    public static final String GUIDE_BACK_NONE = "§6Already at start of guide!";
    public static final String GUIDE_SKIP_ONE = "§aSkipped 1 step!";
    public static final String GUIDE_BACK_ONE = "§aWent back 1 step!";
    public static final String GUIDE_SKIP_MULTIPLE = "§aSkipped %s steps!";
    public static final String GUIDE_BACK_MULTIPLE = "§aWent back %s steps!";

    /* == Step == */
    public static final String STEP_COMPLETE = "§aCompleted §r%s§a in §f%s§a seconds!";
}