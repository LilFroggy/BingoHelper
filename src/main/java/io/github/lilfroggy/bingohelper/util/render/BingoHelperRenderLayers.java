...
public class BingoHelperRenderLayers {
    ...
    public static final MultiPhase FILLED_THROUGH_WALLS = RenderLayer.of("filled_through_walls", RenderLayer.DEFAULT_BUFFER_SIZE, false, true, BingoHelperRenderPipelines.FILLED_THROUGH_WALLS, MultiPhaseParameters.builder()
            .layering(RenderPhase.VIEW_OFFSET_Z_LAYERING)
            .build(false));
    ...
    private static final DoubleFunction<MultiPhase> LINES_THROUGH_WALLS = lineWidth -> RenderLayer.of("lines_through_walls", RenderLayer.DEFAULT_BUFFER_SIZE, false, false, BingoHelperRenderPipelines.LINES_THROUGH_WALLS, MultiPhaseParameters.builder()
            .lineWidth(new LineWidth(OptionalDouble.of(lineWidth)))
            .layering(RenderPhase.VIEW_OFFSET_Z_LAYERING)
            .build(false));
    ...
    public static final MultiPhase QUADS_THROUGH_WALLS = RenderLayer.of("quad_through_walls", RenderLayer.DEFAULT_BUFFER_SIZE, false, true, BingoHelperRenderPipelines.LINES_THROUGH_WALLS, MultiPhaseParameters.builder()
            .layering(RenderPhase.VIEW_OFFSET_Z_LAYERING)
            .build(false));
